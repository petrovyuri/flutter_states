...
abstract class $CounterStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isLoading, int counter, String title});
}
...
class _$_CounterState implements _CounterState {
  const _$_CounterState(
      {this.isLoading = false, required this.counter, required this.title});
  ...
  @override
  String toString() {
    return 'CounterState(isLoading: $isLoading, counter: $counter, title: $title)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, isLoading, counter, title);
...
abstract class _CounterState implements CounterState {
  const factory _CounterState(
      ...
      required final String title}) = _$_CounterState;
